...
class _PaginaConfigurarMacetaState extends State<PaginaConfigurarMaceta> {
  ...
  // Se ha eliminado _wifiListo de la condición para hacerlo opcional
  bool get _todoListo => _plantaLista && _sensoresListos;
                  ...
                  onTap: () async {
                    ...
                    if (ok == true) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('Wi-Fi conectado correctamente')),
                      );
                    }
                  },
                ),

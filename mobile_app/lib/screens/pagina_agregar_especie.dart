...
class _PaginaAgregarEspecieState extends State<PaginaAgregarEspecie> {
  ...
  Widget _sliderContainer(Widget slider) {
    return Container(
          decoration: BoxDecoration(
  ...
  Widget _minMaxLabels(String min, String max) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(min, style: TextStyle(color: Theme.of(context).colorScheme.secondary)),
          Text(max, style: TextStyle(color: Theme.of(context).colorScheme.secondary)),
        ],
      ),
    );
  }

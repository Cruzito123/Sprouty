        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.wifi, color: Theme.of(context).colorScheme.primary, size: 40),
                const SizedBox(height: 12),
                const Text('Buscando Redes WiFi',
                    style: TextStyle(fontWeight: FontWeight.w600)),
                const SizedBox(height: 8),
                Text('Detectando redes disponibles para tu dispositivo',
                    textAlign: TextAlign.center, style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.54))),
    ...
    if (_scanResults.isEmpty) {
      return Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.wifi_off, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.5), size: 40),
            const SizedBox(height: 8),
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, i) {
        ...
        return Card(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          child: ListTile(
            leading: Icon(_wifiIcon(level), color: Theme.of(context).colorScheme.primary),
            title: Text(name),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.signal_wifi_4_bar, color: Theme.of(context).colorScheme.primary),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          enabledBorder: OutlineInputBorder(
                            ...
                            borderSide: BorderSide(color: Theme.of(context).colorScheme.primary.withValues(alpha: 0.25), width: 2),
                          ),
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.wifi, color: Theme.of(context).colorScheme.primary, size: 38),
                const SizedBox(height: 12),
                Text(

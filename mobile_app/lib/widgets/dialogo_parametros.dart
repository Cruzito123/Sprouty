...
class _DialogoParametrosState extends State<DialogoParametros> {
  ...
  Widget _seccion({
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        Icon(icono, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.7)),
  ...
  Widget _campo(String etiqueta, TextEditingController ctrl) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(etiqueta, style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.54), fontSize: 13)),
